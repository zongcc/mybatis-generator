...
public class DefaultCommentGenerator implements CommentGenerator {
    ...
    public void addJavaFileComment(CompilationUnit compilationUnit) {
        ...
        compilationUnit.addFileCommentLine(" * ");
        compilationUnit.addFileCommentLine(" * Created by sohu.com on " + simpleDateFormat.format(new Date()));
        compilationUnit.addFileCommentLine(" * ");
        compilationUnit.addFileCommentLine(" */");
        return;
    }
    ...
    public void addFieldComment(Field field,
        ...
        if(null != introspectedColumn.getRemarks() && !"".equals(introspectedColumn.getRemarks())){
            ...
            field.addJavaDocLine(" * " + new String(introspectedColumn.getRemarks()));
            field.addJavaDocLine(" */");
        }
...
//        field.addJavaDocLine(" */"); //$NON-NLS-1$
    ...
    public void addGetterComment(Method method,
        ...
        if(null != introspectedColumn.getRemarks() && !"".equals(introspectedColumn.getRemarks())){
            ...
            method.addJavaDocLine(" * 获取 " + new String(introspectedColumn.getRemarks()));
            method.addJavaDocLine(" */");
        }
...
//        method.addJavaDocLine(" */"); //$NON-NLS-1$
    ...
    public void addSetterComment(Method method,
        ...
        if(null != introspectedColumn.getRemarks() && !"".equals(introspectedColumn.getRemarks())){
            method.addJavaDocLine("/**");
            method.addJavaDocLine(" * 设置 " + new String(introspectedColumn.getRemarks()));
            method.addJavaDocLine(" */");
        }
